...
Feature: Optimized Create Registry - Step 3: Gift card select
  ...
  Scenario: Verify that user is able to see the checkbox to accept Gift cards is not checked
    Then User should able to see the checkbox to accept Gift cards is not checked

  Scenario:Verify that user is able to select the checkbox to accept Gift cards
    Then User should able to select the checkbox to accept Gift card

  Scenario: Verify that user is able to uncheck the checkbox to accept gift cards
